export default function Hero() {
  return (
    <section id="beranda" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-brand-900/70 via-brand-800/50 to-brand-900/80" />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl text-brand-50 leading-relaxed mb-10 max-w-3xl mx-auto">
          Cerdas secara intelektual, kuat secara spiritual. Kami menyiapkan generasi
          Qur&apos;ani yang berakhlak mulia dan siap menghadapi masa depan.
        </p>
